...
import com.ptit.signlanguage.ui.verify.VerifyActivity
import com.ptit.signlanguage.utils.Constants.FIRST_PHONE_VN
import com.ptit.signlanguage.utils.Constants.KEY_PHONE_NUMBER
import com.ptit.signlanguage.utils.Constants.KEY_RESEND_TOKEN
    ...
    override fun initView() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            binding.tvLogin.text =
                Html.fromHtml(getString(R.string.str_require_login), Html.FROM_HTML_MODE_LEGACY)
        }
    ...
    override fun initListener() {
        ...
        binding.imvShowHidePassRepeat.setOnClickListener {
            if (isPassRepeatShowed) {
                ...
                binding.edtPassRepeat.transformationMethod =
                    PasswordTransformationMethod.getInstance()
                binding.edtPassRepeat.inputType =
                    InputType.TYPE_CLASS_TEXT or InputType.TYPE_TEXT_VARIATION_PASSWORD
