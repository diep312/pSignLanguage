...
class PracticeActivity: BaseActivity<MainViewModel, ActivityPracticeBinding>() {
    ...
    override fun getContentLayout(): Int {
        return R.layout.activity_main_practice
    }
        ...
        binding.bnvMenu.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.btn_video_to_text -> {
                    binding.vp.currentItem = Constants.PAGE_0
                }
                R.id.btn_text_to_video -> {
                    binding.vp.currentItem = Constants.PAGE_1
                }
                R.id.btn_course -> {
                    binding.vp.currentItem = Constants.PAGE_2
                }
                R.id.btn_account -> {
                    binding.vp.currentItem = Constants.PAGE_3
                }
            }
            true
        }
