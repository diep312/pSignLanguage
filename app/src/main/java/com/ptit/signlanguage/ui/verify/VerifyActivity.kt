package com.ptit.signlanguage.ui.verify
...
import com.ptit.signlanguage.databinding.ActivityVerifyBinding
...
import com.ptit.signlanguage.utils.Constants.KEY_VERIFICATION_ID
...
//        mAuth.useAppLanguage()
        ...
        mToken =
            intent.extras!!.getParcelable<PhoneAuthProvider.ForceResendingToken>(Constants.KEY_RESEND_TOKEN)!!
        ...
        timer = object : CountDownTimer(90000, 1000) {
            ...
            override fun onFinish() {
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
                    binding.tvTimeCountDown.text =
                        Html.fromHtml(getString(R.string.str_require_send_otp))
                } else {
                    binding.tvTimeCountDown.text = Html.fromHtml(
                        getString(R.string.str_require_send_otp),
...
//                    confirmOTPFirebase(s.toString())
        ...
        binding.btnVerify.setOnClickListener {
            ...
            val credential = PhoneAuthProvider.getCredential(
                mVerificationId!!,
                binding.layoutOtp.edtOtp.text.toString().trim()
            )
            ...
            .addOnCompleteListener(this) { task ->
                ...
                if (task.isSuccessful) {
                    ...
                    if (task.exception is FirebaseAuthInvalidCredentialsException) {
                        ...
                        Toast.makeText(
                            this@VerifyActivity,
                            getString(R.string.str_otp_fail),
                            Toast.LENGTH_LONG
                        ).show()
    ...
    private val callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        override fun onVerificationFailed(e: FirebaseException) {
            ...
            if (e is FirebaseAuthInvalidCredentialsException) {
                ...
                Toast.makeText(
                    this@VerifyActivity,
                    getString(R.string.str_verify_fail),
                    Toast.LENGTH_LONG
                ).show()
                ...
                Toast.makeText(
                    this@VerifyActivity,
                    getString(R.string.str_too_many_request),
                    Toast.LENGTH_LONG
                ).show()
            }
